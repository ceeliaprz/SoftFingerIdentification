...
def main():
    ...
    for orientation in range(90, 211, 120): #primero el motor 8 y luego solo el 7
        ...
        # print(df)
        df.to_csv(
            '/home/celia/Documentos/ROB. BLANDA/SOFIA_Python/data/Data_prueba_celia/nuevomov/mov3.1.csv', index=False)
        df.info()
